...
with_node \
  ...
  --target "/Users/kimdoyeop/food-runner-mobile-fe/foodRunner/ios/Pods/Target Support Files/Pods-foodRunner/ExpoModulesProvider.swift" \
  --entitlement "/Users/kimdoyeop/food-runner-mobile-fe/foodRunner/ios/foodRunner/foodRunner.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "react-native-image-colors"
